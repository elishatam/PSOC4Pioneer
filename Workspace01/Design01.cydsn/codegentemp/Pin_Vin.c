...
#define SetP4PinDriveMode(shift, mode)  \
    do { \
        Pin_Vin_PC =   (Pin_Vin_PC & \
                                (uint32)(~(uint32)(Pin_Vin_DRIVE_MODE_IND_MASK << (Pin_Vin_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << (Pin_Vin_DRIVE_MODE_BITS * (shift))); \
    } while (0)
...
*
*  Pin_Vin_DM_STRONG     Strong Drive 
*  Pin_Vin_DM_OD_HI      Open Drain, Drives High 
*  Pin_Vin_DM_OD_LO      Open Drain, Drives Low 
*  Pin_Vin_DM_RES_UP     Resistive Pull Up 
*  Pin_Vin_DM_RES_DWN    Resistive Pull Down 
*  Pin_Vin_DM_RES_UPDWN  Resistive Pull Up/Down 
*  Pin_Vin_DM_DIG_HIZ    High Impedance Digital 
*  Pin_Vin_DM_ALG_HIZ    High Impedance Analog 
*
* Return: 
*  None
*
...
{
	SetP4PinDriveMode(Pin_Vin__0__SHIFT, mode);
}
...
*  
* Note:
*  Macro Pin_Vin_ReadPS calls this function. 
*  
*******************************************************************************/
