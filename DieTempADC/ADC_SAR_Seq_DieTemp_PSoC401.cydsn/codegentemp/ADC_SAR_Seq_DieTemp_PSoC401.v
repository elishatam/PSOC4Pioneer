// ======================================================================
// ADC_SAR_Seq_DieTemp_PSoC401.v generated from TopDesign.cysch
// 01/05/2016 at 11:45
...
// DieTemp_P4_v1_0(CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=DieTemp_P4_v1_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=DieTemp, CY_INSTANCE_SHORT_NAME=DieTemp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=DieTemp, )
module DieTemp_P4_v1_0_1 (
    temp);
    inout       temp;
    electrical  temp;
...
// SW_Tx_UART_v1_40(BaudRate=115200, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=SW_Tx_UART_v1_40, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART, CY_INSTANCE_SHORT_NAME=UART, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=40, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP1, INSTANCE_NAME=UART, )
module SW_Tx_UART_v1_40_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f148ccca-7b16-4264-81f4-da4ffa063978/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
